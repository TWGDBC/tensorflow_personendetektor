...
restore_path = projectpath+'model_2018-05-30_17-09-47.ckpt'
restore_path = projectpath+'model_2018-05-30_20-25-50.ckpt'
restore_path = projectpath+'model_2018-05-30_22-09-50.ckpt'
restore_path = projectpath+'model_2018-05-30_22-27-28.ckpt'
restore_path = projectpath+'model_2018-05-30_22-27-28.ckpt'
restore_path = projectpath+'model_2018-05-30_23-30-30.ckpt'
restore_path = projectpath+'model_2018-05-30_23-57-25.ckpt'
restore_path = projectpath+'model_2018-05-31_00-08-52.ckpt'
restore_path = projectpath+'model_2018-05-31_00-28-30.ckpt' ## sehr gut
restore_path = projectpath+'model_2018-05-31_00-54-01.ckpt'
showRestore = True;
showOptimize = False;
#showRestore = False;
#showOptimize = True;
...
train_batch_size = 200  # batch size is ~1% of the training size
...
strides3 = 1
poolsize3 = 2
filter_size4 = 2      # Convolution filters are 3 x 3 pixels.
